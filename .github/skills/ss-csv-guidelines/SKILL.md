...
- **遵守仓库全局约束**：ss-csv 的生成/写回流程以 `.github/copilot-instructions.md` 为准（默认只生成到 build）。
...
> - 通用文本：`.github/skills/csv-text-guidelines/SKILL.md`
> - weapon_data.csv：`.github/skills/weapon-csv-guidelines/SKILL.md`
...
- `.github/copilot-instructions.md`：ss-csv 默认只生成到 build、写回需要明确要求。
- `.github/skills/weapon-tooltip-descriptions/SKILL.md`：tooltip 多行/高亮/百分号等 CSV 文本安全规则。
