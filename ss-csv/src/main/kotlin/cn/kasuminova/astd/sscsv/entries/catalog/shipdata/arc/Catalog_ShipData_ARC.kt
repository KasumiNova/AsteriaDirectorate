...
object Ship_astd_arc_jet : ShipDataEntry() {
    ...
    override val designation: String = "主力舰"
    override val tech: String = "弧光阵列"
    override val systemId: String = "astd_micro_burn_drive"
    override val fleetPts: Int = 45
    override val hitpoints: Int = 14000
    override val armorRating: Int = 1400
    override val maxFlux: Int = 16000
    override val fluxDissipation: Int = 800
    override val ordnancePoints: Int = 240
    override val maxSpeed: Int = 45
    override val acceleration: Int = 22
    override val deceleration: Int = 22
    override val maxTurnRate: Int = 30
    override val turnAcceleration: Int = 60
    override val mass: Int = 30000
    override val shieldType: String = "FRONT"
...
object Ship_astd_plasma_arch : ShipDataEntry() {
    ...
    override val tech: String = "弧光阵列"
    override val systemId: String = "astd_fire_control_array"
    override val fleetPts: Int = 24
    override val hitpoints: Int = 7500
    override val armorRating: Int = 900
    override val maxFlux: Int = 10000
...
object Ship_astd_radiation_belt : ShipDataEntry() {
    ...
    override val designation: String = "驱逐舰"
    override val tech: String = "弧光阵列"
    override val systemId: String = "astd_high_energy_loader"
    override val fleetPts: Int = 11
    override val hitpoints: Int = 3500
    override val armorRating: Int = 400
    override val maxFlux: Int = 4500
    override val fluxDissipation: Int = 350
    ...
    override val crPercentPerDay: Double = 5.0
    override val crToDeploy: Double = 15.0
    override val peakCrSec: Int = 300
    override val crLossPerSec: Double = 0.25
