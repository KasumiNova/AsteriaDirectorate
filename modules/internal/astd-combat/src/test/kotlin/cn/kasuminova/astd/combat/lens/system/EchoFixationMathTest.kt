...
class EchoFixationMathTest {
    ...
    @Test
    fun `cognitive tear base damage taken scales with difficulty`() {
    ...
    @Test
    fun `standstill bonus is max at overlap and decays to floor at edge`() {
    ...
    @Test
    fun `system range mult scales the standstill range`() {
    ...
    @Test
    fun `field radius scales with system range`() {
