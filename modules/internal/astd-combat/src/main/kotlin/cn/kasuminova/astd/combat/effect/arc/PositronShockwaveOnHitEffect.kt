...
class PositronShockwaveOnHitEffect : OnHitEffectPlugin {
    ...
    override fun onHit(
        ...
        val dir = if (vel.lengthSquared() > 1e-3f) {
            ...
            Vector2f(kotlin.math.cos(rad).toFloat(), kotlin.math.sin(rad).toFloat())
        }
    ...
    companion object {
        private val log = com.fs.starfarer.api.Global.getLogger(PositronShockwaveOnHitEffect::class.java)
