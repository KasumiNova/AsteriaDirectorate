 ...
 * <ul>
 *   <li><b>Crewed lens</b> ({@code astd_zw_001_Standard}, default dual-mode = crewed):
 ...
 *   <li><b>Unmanned lens</b> ({@code astd_zw_001_Automated}, permaMod = automated mode):
...
public final class MissionDefinition implements MissionDefinitionPlugin {
    ...
    public void defineMission(final MissionDefinitionAPI api) {
        ...
        api.addToFleet(FleetSide.PLAYER, "astd_zw_001_Automated", FleetMemberType.SHIP, false);
