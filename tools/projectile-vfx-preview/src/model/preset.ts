...
export function createDefaultTrailEntityConfig(id = 'astd_default_trail'): TrailEntityConfig {
  return {
    ...
    startColor: [0.278431, 0.847059, 0.921569, 0.92],
    endColor: [0.039216, 0.164706, 0.219608, 0.06],
    startEmissive: [1, 0.95, 0.98, 1],
    endEmissive: [0.039216, 0.223529, 0.458824, 0.16],
    startWidth: 80,
    endWidth: 4,
    texturePixels: 96,
    textureSpeed: 0.9,
...
export function createDefaultTrailRibbonDecorationConfig(id = 'astd_default_ribbon_0'): TrailRibbonDecorationConfig {
  return {
    ...
    noiseScale: 2.0,
    blur: 9,
    startColor: [1, 1, 1, 0.92],
    endColor: [0.494118, 0.658824, 0.92549, 0.06],
    color: [0.756863, 0.909804, 0.984314, 0.92],
    colorGradient: {
      enabled: false,
      stops: [],
    },
    ...
    headLayers: [
      {
        ...
        shoulderRatio: 0.5,
        rearRatio: 0.95,
        shellColorStart: [0.039216, 0.164706, 0.219608, 0.08],
        shellColorMid: [0.756863, 0.909804, 0.984314, 0.46],
    ...
    mistLayers: [
      {
        ...
        noiseScale: 5.2,
        driftSpeed: 0.32,
        colorStart: [0.039216, 0.164706, 0.219608, 0.06],
