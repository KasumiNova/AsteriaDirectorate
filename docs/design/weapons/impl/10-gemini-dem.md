...
```json
{
    ...
    "hardpointOffsets": [8, 0],                "pod: [14, 0]（v1 占位；双管实装后以弹体左上角放置点实测回填：发射架（7,0）/（19,0）→ hardpoint [17.5, 6, 17.5, -6] / turret [7.5, 6, 7.5, -6]；发射舱 43×45 画布（9,0）/（23,0）→ hardpoint [21.25, 6.5, 21.25, -7.5] / turret [10, 6.5, 10, -7.5]。语义 [前向, 横向]，横向正值=左舷；hardpoint 贴图锚点在 3/4 高度、turret 在 1/2；0 号管左舷红/1 号管右舷蓝）",
    "turretOffsets": [3, 0],                   "pod: [8, 0]（同上）",
